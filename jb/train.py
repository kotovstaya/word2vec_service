...
from models import CustomWord2Vec
...
class FromBoxTrainer:
    ...
    def train_model(self):
        ...
        self.model.build_vocab(corpus, progress_per=self.progress_per)
...
class CustomTrainer:
    def __init__(self,
                 ...
                 lr: float,
                 epochs: int):
        self.logger = get_logger(CustomTrainer.__name__)
    ...
    def _init_model(self, vocab_size, emb_dim):
        ...
        return CustomWord2Vec(vocab_size, emb_dim)
    ...
    def train_model(self):
        ...
        for epoch in range(self.epochs):
            ...
            for i, (words, contexts, labels) in tqdm.tqdm(enumerate(self.dataloader)):
                # self.logger.warning(f"batch_size: {words.shape}")
